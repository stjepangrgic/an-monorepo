...
const IndexPage = () => {
  ...
  return (
    <PageLayout>
      ...
      <Hero>
        <Container>
          <Title h="1" css={css`color: #fff`}>Hear More</Title>
          <Text css={css`color: #fff`}>With over 175,000 tracks - discover the music to tell your story</Text>
      ...
      <Container>
        ...
        <Text>Whatever your project and wherever you're from, we have a wealth of music and tailored licences just to suit you</Text>
        ...
        {musicSolutions.map((solution, index) => {
          return (
            <div className="music-solution" key={index}>
              ...
              <GatsbyLink to={solution.url}>Learn more</GatsbyLink>
            </div>)
        })}
      </Container>
